  ...
  return (
    <div className="w-[100%]">
      <div className="flex items-center h-10 bg-amazonclone-yellow rounded">
        <select onChange={(e) => setCategory(e.target.value)} className=" p-2 bg-gray-300 text-black  border text-xs xl:text-sm rounded-l-sm">
          <option>All </option>
          <option>Deals</option>
        ...
        <input
          className="flex  grow items-center h-[100%] rounded-l text-black placeholder:text-gray-500"
          type="text"
          value={searchTerm}
